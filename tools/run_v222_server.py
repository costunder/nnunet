...
def stages(medical,output,profile_batch,allocator_gb,edge_workspace_mib=64,*,optimized=False,cache=None,resume=None,migrate_workspace=None):
...
def main():
    ...
    a=p.parse_args()
    if a.migrate_workspace_mib is not None and (not a.resume or a.runtime!='optimized'):
    ...
    plan=stages(medical,output,a.profile_batch,a.profile_allocator_gb,a.edge_workspace_mib,
                optimized=a.runtime=='optimized',cache=a.cache,resume=a.resume,migrate_workspace=a.migrate_workspace_mib)
