...
TRAINER='nnUNetTrainer_250epochs_OnlinePromptGraphV22'
...
def runtime(root):
    ...
    path=trainer/'nnUNetTrainer_OnlinePromptGraphV22.py'
    if path.exists(): raise ValueError('Conflicting pre-existing v2 trainer')
    shutil.copy2(ROOT/'hiercp_v22/nnUNetTrainer_OnlinePromptGraphV22.py',path)
