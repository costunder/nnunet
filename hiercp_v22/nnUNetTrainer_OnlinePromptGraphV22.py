...
from hiercp_v22.contracts import read_json,sha,validate_native

class nnUNetTrainer_250epochs_OnlinePromptGraphV22(_nnUNetTrainer_250epochs_OnlineCP):
    ...
    def __init__(self,plans,configuration,fold,dataset_json,device=torch.device('cuda')):
        ...
        from hiercp_v22.bank import validate_catalog
    ...
    def get_dataloaders(self):
        ...
        from hiercp_v22.native_adapter import MaterializationService,native_dataloaders
