...
from hiercp_v221 import PIPELINE_VERSION
from hiercp_v221.contracts import read_json,sha,validate_native

class nnUNetTrainer_250epochs_OnlinePromptGraphV221(_nnUNetTrainer_250epochs_OnlineCP):
    ...
    def __init__(self,plans,configuration,fold,dataset_json,device=torch.device('cuda')):
        ...
        if meta['selection']!='cross_patient_positive_transport_argmax' or meta['candidate_count']!=128 or meta['cp_probability']!=.5:
        ...
        from hiercp_v221.bank import validate_catalog
    ...
    def get_dataloaders(self):
        ...
        from hiercp_v221.native_adapter import MaterializationService,native_dataloaders
        self.v2_service=MaterializationService(self.online_bank_path,self.v2_gpu_lock)
        return native_dataloaders(self,_nnUNetTrainer_250epochs_OnlineCP.get_dataloaders)
